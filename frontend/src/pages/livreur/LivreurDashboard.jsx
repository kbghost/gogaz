...
export default function LivreurDashboard() {
  ...
  const STATS = [
    { label:'En attente',  val:totalAttente,  icon:'⏳', color:'#fbbf24', bg:'rgba(251,191,36,0.1)',  border:'rgba(251,191,36,0.2)' },
    { label:'En livraison', val:totalEnCours,  icon:'🚚', color:'#f97c0a', bg:'rgba(249,124,10,0.1)',  border:'rgba(249,124,10,0.2)' },
    { label:'Livrées',     val:totalLivrees,  icon:'✅', color:'#34d399', bg:'rgba(52,211,153,0.1)',   border:'rgba(52,211,153,0.2)' },
  ]
  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:'20px', paddingTop:'8px' }}>
      ...
      {urgentes.length > 0 && (
        <div>
          <h2 style={{ fontFamily:'var(--font-display)', fontWeight:700, color:'var(--c-text)', fontSize:'1rem', marginBottom:'12px' }}>
                ...
                >
                  ...
                  <div style={{ flex:1, minWidth:0 }}>
                    <div style={{ display:'flex', alignItems:'center', gap:'6px', marginBottom:'2px' }}>
                      ...
                      <span style={{ background: c.type==='gaz' ? 'rgba(249,124,10,0.1)' : 'rgba(96,165,250,0.1)', color: c.type==='gaz' ? '#f97c0a' : '#60a5fa', fontSize:'0.6rem', fontFamily:'var(--font-mono)', padding:'1px 6px', borderRadius:'99px' }}>{c.type==='gaz'?'⛽ GAZ':'🔧 ACC'}</span>
                    </div>
